...
// ─── Navbar Translations ───
const navT = {
  en: { features: "Features", pricing: "Pricing", guidelines: "Guidelines", contact: "Contact", support: "Support", more: "More", terms: "Terms", privacy: "Privacy", signIn: "Sign In", getStarted: "Get Started Free" },
  hi: { features: "सुविधाएं", pricing: "मूल्य निर्धारण", guidelines: "दिशानिर्देश", contact: "संपर्क", support: "सहायता", more: "अधिक", terms: "शर्तें", privacy: "गोपनीयता", signIn: "साइन इन", getStarted: "मुफ्त शुरू करें" },
  mr: { features: "वैशिष्ट्ये", pricing: "किंमत", guidelines: "मार्गदर्शक तत्त्वे", contact: "संपर्क", support: "मदत", more: "अधिक", terms: "अटी", privacy: "गोपनीयता", signIn: "साइन इन", getStarted: "मोफत सुरू करा" },
  pa: { features: "ਵਿਸ਼ੇਸ਼ਤਾਵਾਂ", pricing: "ਕੀਮਤ", guidelines: "ਦਿਸ਼ਾ-ਨਿਰਦੇਸ਼", contact: "ਸੰਪਰਕ", support: "ਸਹਾਇਤਾ", more: "ਹੋਰ", terms: "ਸ਼ਰਤਾਂ", privacy: "ਗੋਪਨੀਯਤਾ", signIn: "ਸਾਈਨ ਇਨ", getStarted: "ਮੁਫਤ ਸ਼ੁਰੂ ਕਰੋ" },
};
...
export function PublicNavbar() {
  ...
  const navLinks = [
    ...
    { label: t.support, href: "/support" }, // <-- Added Support link here
